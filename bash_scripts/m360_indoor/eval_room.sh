#!/bin/bash
#SBATCH --output=logs/eval_room.log
...
python train.py \
-s /gpfs/scratch/acad/telim/datasets/MipNeRF360/room  \
-i images_2 \
-m models/$1/room \
--quiet \
--eval \
...
python render.py --iteration 30000 -s /gpfs/scratch/acad/telim/datasets/MipNeRF360/room -m models/$1/room --eval --skip_train --quiet

python metrics.py -m models/$1/room