#!/bin/bash
#SBATCH --output=logs/eval_kitchen.log
...
python train.py \
-s /gpfs/scratch/acad/telim/datasets/MipNeRF360/kitchen  \
-i images_2 \
-m models/$1/kitchen \
--quiet \
--eval \
...
python render.py --iteration 30000 -s /gpfs/scratch/acad/telim/datasets/MipNeRF360/kitchen -m models/$1/kitchen --eval --skip_train --quiet

python metrics.py -m models/$1/kitchen